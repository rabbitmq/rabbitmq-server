...
dep_khepri = git https://github.com/rabbitmq/khepri tmp-to-debug-khepri-fence-in-ci
dep_khepri_mnesia_migration = hex 0.7.1
dep_osiris = git https://github.com/rabbitmq/osiris v1.8.6
dep_prometheus = hex 4.11.0
dep_ra = git https://github.com/rabbitmq/ra tmp-to-debug-khepri-fence-in-ci
dep_ranch = hex 2.2.0
dep_recon = hex 2.5.6
