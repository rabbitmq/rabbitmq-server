...
Khepri is the only [schema data store](https://www.rabbitmq.com/docs/metadata-store) since `4.3.0`,
so test suites always run against it. `RABBITMQ_METADATA_STORE` is no longer read.
