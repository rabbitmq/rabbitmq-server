...
def secondary_umbrella():
    http_archive(
        ...
        strip_prefix = "rabbitmq_server-3.9.29",
        urls = [
            "https://rabbitmq-github-actions.s3.eu-west-1.amazonaws.com/secondary-umbrellas/package-generic-unix-for-mixed-version-testing-v3.9.29.tar.xz",
        ],
    )
