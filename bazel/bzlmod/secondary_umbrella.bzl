...
def secondary_umbrella():
    http_archive(
        ...
        strip_prefix = "rabbitmq_server-3.13.0",
        # This file is produced just in time by the test-mixed-versions.yaml GitHub Actions workflow.
        urls = [
            "https://rabbitmq-github-actions.s3.eu-west-1.amazonaws.com/secondary-umbrellas/rbe-26_1/package-generic-unix-for-mixed-version-testing-v3.13.0.tar.xz",
        ],
    )
