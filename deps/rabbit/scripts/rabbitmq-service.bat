...
"!ERLANG_SERVICE_MANAGER_PATH!\erlsrv.exe" list !RABBITMQ_SERVICENAME! 2>NUL 1>NUL
if errorlevel 1 (
    "!ERLANG_SERVICE_MANAGER_PATH!\erlsrv.exe" add !RABBITMQ_SERVICENAME! -internalservicename !RABBITMQ_SERVICENAME!
) else (
...
rem
rem Note that env vars passed via -env are from these files:
rem rabbitmq-env.conf.5
rem rabbitmq-server.8
rem deps/rabbit_common/src/rabbit_env.erl - USED_ENV_VARS
...
-env RABBITMQ_ADVANCED_CONFIG_FILE="!RABBITMQ_ADVANCED_CONFIG_FILE!" ^
-env RABBITMQ_BASE="!RABBITMQ_BASE!" ^
-env RABBITMQ_CONF_ENV_FILE="!RABBITMQ_CONF_ENV_FILE!" ^
-env RABBITMQ_CONFIG_FILE="!RABBITMQ_CONFIG_FILE!" ^
-env RABBITMQ_CONFIG_FILES="!RABBITMQ_CONFIG_FILES!" ^
...
-env RABBITMQ_ENABLED_PLUGINS="!RABBITMQ_ENABLED_PLUGINS!" ^
-env RABBITMQ_ENABLED_PLUGINS_FILE="!RABBITMQ_ENABLED_PLUGINS_FILE!" ^
-env RABBITMQ_ERLANG_COOKIE="!RABBITMQ_ERLANG_COOKIE!" ^
-env RABBITMQ_FEATURE_FLAGS="!RABBITMQ_FEATURE_FLAGS!" ^
-env RABBITMQ_FEATURE_FLAGS_FILE="!RABBITMQ_FEATURE_FLAGS_FILE!" ^
-env RABBITMQ_KEEP_PID_FILE_ON_EXIT="!RABBITMQ_KEEP_PID_FILE_ON_EXIT!" ^
-env RABBITMQ_LOG="!RABBITMQ_LOG!" ^
-env RABBITMQ_LOG_BASE="!RABBITMQ_LOG_BASE!" ^
-env RABBITMQ_LOG_FF_REGISTRY="!RABBITMQ_LOG_FF_REGISTRY!" ^
-env RABBITMQ_LOGS="!RABBITMQ_LOGS!" ^
-env RABBITMQ_MNESIA_BASE="!RABBITMQ_MNESIA_BASE!" ^
-env RABBITMQ_MNESIA_DIR="!RABBITMQ_MNESIA_DIR!" ^
-env RABBITMQ_NODE_IP_ADDRESS="!RABBITMQ_NODE_IP_ADDRESS!" ^
-env RABBITMQ_NODE_PORT="!RABBITMQ_NODE_PORT!" ^
-env RABBITMQ_NODENAME="!RABBITMQ_NODENAME!" ^
-env RABBITMQ_PID_FILE="!RABBITMQ_PID_FILE!" ^
-env RABBITMQ_PLUGINS_DIR="!RABBITMQ_PLUGINS_DIR!" ^
-env RABBITMQ_PLUGINS_EXPAND_DIR="!RABBITMQ_PLUGINS_EXPAND_DIR!" ^
-env RABBITMQ_QUORUM_DIR="!RABBITMQ_QUORUM_DIR!" ^
-env RABBITMQ_STREAM_DIR="!RABBITMQ_STREAM_DIR!" ^
-env RABBITMQ_UPGRADE_LOG="!RABBITMQ_UPGRADE_LOG!" ^
...
"!ERLANG_SERVICE_MANAGER_PATH!\erlsrv.exe" !P1! !RABBITMQ_SERVICENAME!
if ERRORLEVEL 1 (
    EXIT /B 1
)
goto END
