...
get_time_diff(TotalBytes, Interval, SyncThroughput) ->
    rabbit_log_mirroring:debug("Total ~tp bytes has been sent over last ~tp ms. Effective sync throughput: ~tp", [TotalBytes, Interval, round(TotalBytes * 1000 / Interval)]),
