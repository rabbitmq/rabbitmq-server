...
%% Used for the `replaced_delete_queue_transaction' feature flag.
-export([replaced_delete_queue_transaction_enable/1]).
...
replaced_delete_queue_transaction_enable(#{feature_name := FeatureName}) ->
    ?LOG_DEBUG(
