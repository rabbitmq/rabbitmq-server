...
memory() ->
    ...
    {QueueSupsStatsKeys, QueueStatsSups} = case rabbit:is_running() of
                                               true -> rabbit_queue_type:queue_vm_stats_sups();
                                               false -> {[], []}
                                           end,
    ...
    {QueuesEtsStatsKeys, QueueStatsEtsNames} = case rabbit:is_running() of
                                                   true -> rabbit_queue_type:queue_vm_ets();
                                                   false -> {[], []}
                                               end,
