...
defmodule SoleConnectionForceDeleteCommandTest do
  use ExUnit.Case, async: false
  import TestHelper

  @command RabbitMQ.CLI.Ctl.Commands.SoleConnectionForceDeleteCommand
  ...
  test "run: force-deleting a lease that does not exist returns an error", context do
    ...
    :ok = :rpc.call(node, :rabbit_sole_conn, :ensure_running, [])
