...
basic_parse_test_() ->
    ...
    , ?_assertMatch( {'=', 3.0, 3.3},                                   analyze(?TEST_TYPE_INFO, "3F = 3.3                     "))
    , ?_assertMatch( {'=', 3.0, 3.3},                                   analyze(?TEST_TYPE_INFO, "3.0d = 3.3                   "))
    , ?_assertMatch( {'=', 3.1, 3.3},                                   analyze(?TEST_TYPE_INFO, "3.1D = 3.3                   "))
    , ?_assertMatch( {'=', 3.0, 3.3},                                   analyze(?TEST_TYPE_INFO, "3.0f = 3.3                   "))
    , ?_assertMatch( {'=', 3.1, 3.3},                                   analyze(?TEST_TYPE_INFO, "3.1F = 3.3                   "))
