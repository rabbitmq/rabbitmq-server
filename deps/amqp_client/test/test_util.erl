...
amqp_url_parse_test() ->
    ...
    ?assertMatch({ok, #amqp_params_network{username     = <<"user">>,
                                           ...
                                           port         = 10000,
                                           virtual_host = <<"vhost">>}},
                 amqp_url:parse("amqp://user:pass@host:10000/vhost")),
    ...
    ?assertMatch({ok, #amqp_params_network{}}, amqp_url:parse("amqp://")),
    ?assertMatch({ok, #amqp_params_network{username     = <<"">>,
                                           password     = <<"">>,
                                           virtual_host = <<"">>}},
                 amqp_url:parse("amqp://:@/")),
    ?assertMatch({ok, #amqp_params_network{username = <<"user">>}},
                 amqp_url:parse("amqp://user@")),
    ?assertMatch({ok, #amqp_params_network{username = <<"user">>,
                                           password = <<"pass">>}},
                 amqp_url:parse("amqp://user:pass@")),
    ?assertMatch({ok, #amqp_params_network{host = "host"}},
                 amqp_url:parse("amqp://host")),
    ?assertMatch({ok, #amqp_params_network{port = 10000}},
                 amqp_url:parse("amqp://:10000")),
    ?assertMatch({ok, #amqp_params_network{virtual_host = <<"vhost">>}},
                 amqp_url:parse("amqp:///vhost")),
    ?assertMatch({ok, #amqp_params_network{host         = "host",
                                           virtual_host = <<"">>}},
                 amqp_url:parse("amqp://host/")),
    ?assertMatch({ok, #amqp_params_network{host         = "host",
                                           virtual_host = <<"/">>}},
                 amqp_url:parse("amqp://host/%2f")),
    ?assertMatch({ok, #amqp_params_network{host = "::1"}},
                 amqp_url:parse("amqp://[::1]")),

    %% Varous other cases
    ?assertMatch({ok, #amqp_params_network{host = "host", port = 100}},
                 amqp_url:parse("amqp://host:100")),
    ?assertMatch({ok, #amqp_params_network{host = "::1", port = 100}},
                 amqp_url:parse("amqp://[::1]:100")),

    ?assertMatch({ok, #amqp_params_network{host         = "host",
                                           virtual_host = <<"blah">>}},
                 amqp_url:parse("amqp://host/blah")),
    ?assertMatch({ok, #amqp_params_network{host         = "host",
                                           port         = 100,
                                           virtual_host = <<"blah">>}},
                 amqp_url:parse("amqp://host:100/blah")),
    ?assertMatch({ok, #amqp_params_network{port         = 100,
                                           virtual_host = <<"blah">>}},
                 amqp_url:parse("amqp://:100/blah")),
    ?assertMatch({ok, #amqp_params_network{host         = "::1",
                                           virtual_host = <<"blah">>}},
                 amqp_url:parse("amqp://[::1]/blah")),
    ?assertMatch({ok, #amqp_params_network{host         = "::1",
                                           port         = 100,
                                           virtual_host = <<"blah">>}},
                 amqp_url:parse("amqp://[::1]:100/blah")),

    ?assertMatch({ok, #amqp_params_network{username = <<"user">>,
                                           password = <<"pass">>,
                                           host     = "host"}},
                 amqp_url:parse("amqp://user:pass@host")),
    ?assertMatch({ok, #amqp_params_network{username = <<"user">>,
                                           password = <<"pass">>,
                                           port     = 100}},
                 amqp_url:parse("amqp://user:pass@host:100")),
    ?assertMatch({ok, #amqp_params_network{username = <<"user">>,
                                           password = <<"pass">>,
                                           port     = 100}},
                 amqp_url:parse("amqp://user:pass@:100")),
    ?assertMatch({ok, #amqp_params_network{username = <<"user">>,
                                           password = <<"pass">>,
                                           host     = "::1"}},
                 amqp_url:parse("amqp://user:pass@[::1]")),
    ?assertMatch({ok, #amqp_params_network{username = <<"user">>,
                                           password = <<"pass">>,
                                           host     = "::1",
                                           port     = 100}},
                 amqp_url:parse("amqp://user:pass@[::1]:100")),

    %% Various failure cases
    ?assertMatch({error, _}, amqp_url:parse("http://www.rabbitmq.com")),
    ?assertMatch({error, _}, amqp_url:parse("amqp://foo:bar:baz")),
    ?assertMatch({error, _}, amqp_url:parse("amqp://foo[::1]")),
    ?assertMatch({error, _}, amqp_url:parse("amqp://foo:[::1]")),
    ?assertMatch({error, _}, amqp_url:parse("amqp://[::1]foo")),
    ?assertMatch({error, _}, amqp_url:parse("amqp://foo:1000xyz")),
    ?assertMatch({error, _}, amqp_url:parse("amqp://foo:1000000")),
    ?assertMatch({error, _}, amqp_url:parse("amqp://foo/bar/baz")),

    ?assertMatch({error, _}, amqp_url:parse("amqp://foo%1")),
    ?assertMatch({error, _}, amqp_url:parse("amqp://foo%1x")),
    ?assertMatch({error, _}, amqp_url:parse("amqp://foo%xy")),
