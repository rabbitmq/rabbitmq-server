...
init_per_testcase(Testcase, Config) ->
    ...
    {ok, _} = rabbit_ct_broker_helpers:rabbitmqctl(Config, 0,
        ["set_topic_permissions",  "-p", "/", "guest", "amq.topic",
            "will-test-[0-9]|test-topic|test-retained-topic|.*mid.*|.*topic.*|{username}.{client_id}.a|^sp[AB]v\\d+___\\d+",
            "will-test-[0-9]|test-topic|test-retained-topic|.*mid.*|.*topic.*|last-will|{username}.{client_id}.a|^sp[AB]v\\d+___\\d+"]),
