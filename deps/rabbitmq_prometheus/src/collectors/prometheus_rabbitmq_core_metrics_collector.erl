        ...
        [
         ...
         {node_persister_metrics,
          [{2, node_io_read_total, counter, "Read operations since node start.", io_read_count},
           ...
           {2, node_io_read_microseconds, gauge, "Total time of read operations.", io_read_time},
           ...
           {2, node_io_write_microseconds, gauge, "Total time of write operations.", io_write_time},
           {2, node_io_sync_total, counter, "Sync operations since node start.", io_sync_count},
           {2, node_io_sync_microseconds, gauge, "Total time of sync operations.", io_sync_time},
           {2, node_io_seek_total, counter, "Seek operations since node start.", io_seek_count},
           {2, node_io_seek_microseconds, gauge, "Total time of seek operations.", io_seek_time},
           ...
           {2, queue_io_file_handle_open_attempt_microseconds, gauge, "Total time of file descriptor open attempts.",
         ...
         {node_metrics,
          [{2, node_fd_total, gauge, "File descriptors available.", fd_total},
           ...
           {2, node_uptime_milliseconds, gauge, "Time in milliseconds since node start.", uptime},
