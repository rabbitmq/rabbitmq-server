...
def all_beam_files(name = "all_beam_files"):
    ...
    erlang_bytecode(
        ...
        srcs = [
            ...
            "src/rabbit_oauth_provider.erl",
            "src/rabbit_resource_server.erl",
...
def test_suite_beam_files(name = "test_suite_beam_files"):
    ...
    erlang_bytecode(
        name = "rabbit_oauth_provider_SUITE_beam_files",
        testonly = True,
        srcs = ["test/rabbit_oauth_provider_SUITE.erl"],
        outs = ["test/rabbit_oauth_provider_SUITE.beam"],
        app_name = "rabbitmq_auth_backend_oauth2",
        erlc_opts = "//:test_erlc_opts",
        deps = ["//deps/oauth2_client:erlang_app"],
    )
    erlang_bytecode(
        name = "rabbit_resource_server_SUITE_beam_files",
        testonly = True,
        srcs = ["test/rabbit_resource_server_SUITE.erl"],
        outs = ["test/rabbit_resource_server_SUITE.beam"],
        app_name = "rabbitmq_auth_backend_oauth2",
        erlc_opts = "//:test_erlc_opts",
        deps = ["//deps/oauth2_client:erlang_app"],
    )
