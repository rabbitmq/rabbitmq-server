...
get_test() ->
    ...
    Publish(<<"2aaa">>),
    Publish(<<"3aaa">>),
    [Msg] = http_post("/queues/%2f/myqueue/get", [{ackmode,  ack_requeue_false},
                                                  {count,    1},
                                                  {encoding, auto},
                                                  {truncate, 1}], ?OK),
    ...
    [M2, M3] = http_post("/queues/%2f/myqueue/get", 
    ...
    2 = length(http_post("/queues/%2f/myqueue/get", 
    ...
    Publish(<<"4aaa">>),
    Publish(<<"5aaa">>),
    [M4, M5] = http_post("/queues/%2f/myqueue/get", 
    ...
    [] = http_post("/queues/%2f/myqueue/get", [{ackmode,  ack_requeue_false},
                                               {count,    5},
                                               {encoding, auto}], ?OK),
...
publish_test() ->
    ...
    [Msg2] = http_post("/queues/%2f/myqueue/get", [{ackmode,  ack_requeue_false},
                                                   {count,    1},
                                                   {encoding, auto}], ?OK),
    assert_item(Msg, Msg2),
    http_post("/exchanges/%2f/amq.default/publish", Msg2, ?OK),
    [Msg3] = http_post("/queues/%2f/myqueue/get", [{ackmode,  ack_requeue_false},
                                                   {count,    1},
                                                   {encoding, auto}], ?OK),
