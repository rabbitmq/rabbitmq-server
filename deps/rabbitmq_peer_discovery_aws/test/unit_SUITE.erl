...
groups() ->
    [
     {unit, [], [
                 ...
                 invalid_hostname_paths_graceful_handling,
...
invalid_hostname_paths_graceful_handling(_Config) ->
    ok = eunit:test({
      ...
      [{"out of bounds index - should not crash",
       ...
       {"empty network interface set - should not crash",
        fun() ->
