...
This release upgrades the [Ra](https://github.com/rabbitmq/ra) dependency to `3.0.0` and introduces
 ...
 * Quorum queues now support **delayed retry** with configurable exponential backoff. When messages
 ...
 * `ra` was upgraded from [`2.17.2`](https://github.com/rabbitmq/ra/releases/tag/v2.17.2) to [`3.0.0`](https://github.com/rabbitmq/ra/releases/tag/v3.0.0)
