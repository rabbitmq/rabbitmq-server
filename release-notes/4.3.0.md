...
won't be a breaking change for nearly all instalations but
 ...
 * `osiris` was upgraded to [`0.9.1`](https://github.com/rabbitmq/gen-batch-server/releases)
 * `cuttlefish` was upgraded to [`3.6.0`](https://github.com/kyorai/cuttlefish/releases)
 * `gen_batch_server` was upgraded to [`1.3.0`](https://github.com/rabbitmq/osiris/releases)
