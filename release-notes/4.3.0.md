 ...
 * AMQP 1.0: attaching with a lin[k handle already in use on the same session is now rejecte](https://github.com/rabbitmq/rabbitmq-server/pull/16039)d
   with a `handle-in-use` session[ error, as required by the specificatio](https://github.com/rabbitmq/rabbitmq-server/pull/16039)n
