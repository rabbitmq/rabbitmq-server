 ...
 * Passive queue and exchange declarations are now allowed for users that have **any** permission
   ...
   GitHub issue: [#16272](https://github.com/rabbitmq/rabbitmq-server/pull/16272), [#16085](https://github.com/rabbitmq/rabbitmq-server/pull/16085)

 * Classic queue shared message store GC could fall behind other queue activity under heavy load

   GitHub issue: [#16142](https://github.com/rabbitmq/rabbitmq-server/pull/16142), [#16141](https://github.com/rabbitmq/rabbitmq-server/issues/16141)
 ...
 * It is now possible to cap the maximum number of concurreht HTTP API connections using the `management.tcp.max_connections`,
 ...
 * It is now possible to cap the maximum number of concurreht HTTP API connections using the `prometheus.tcp.max_connections`,
 ...
 * It is now possible to cap the maximum number of concurreht HTTP API connections using the `mqtt.max_connections`
 ...
 * Federation links could fail to start during rolling cluster restarts.
   ...
   GitHub issue: [#16234](https://github.com/rabbitmq/rabbitmq-server/pull/16234), [#16224](https://github.com/rabbitmq/rabbitmq-server/issues/16224)
