...
and a [new RabbitMQ website](https://www.rabbitmq.com/).
...
This 3.13.0 release includes a change to the RabbitMQ website, a new versioned website.  Access it [here](https://www.rabbitmq.com/).

Some of it's great features include:

* Documentation versions:  When you access the "Docs" tab on the RabbitMQ website, you are viewing documentation for this current 3.13.0 release. The default drop-down option on the top of any page on the far right displays "3.13". You can also access documentation for previous 3.12.x releases. Note, when you select the "3.12" drop-down option, you are taken back to the previous RabbitMQ website, documentation at this site is not versioned, it contains all documentation for previous RabbitMQ releases up to 3.12.x. Over time, the RabbitMQ website will include documentation on a few most recent minor release series but for now as the new website is just launched, it is just documentation for the latest one.
