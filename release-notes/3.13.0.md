...
* Documentation versions:  Access documentation for the 3.13.0 release [here](https://www.rabbitmq.com/docs/documentation).  Over time, the RabbitMQ website will include documentation on a few most recent minor release series but for now as the new website is just launched, it is just documentation for the latest one.
