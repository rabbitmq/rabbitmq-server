...
http_file(
    name = "otp_src_24",
    downloaded_file_path = "OTP-24.3.4.15.tar.gz",
    sha256 = "2c014720eb2d2da7f195e4c7ced20b6e9eed664b6d65e2083be9e698e63224df",
    urls = ["https://github.com/erlang/otp/archive/OTP-24.3.4.15.tar.gz"],
)
