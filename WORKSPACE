...
http_file(
    name = "otp_src_26_2",
    downloaded_file_path = "OTP-26.2.3.tar.gz",
    sha256 = "7a79e7955890b06572dbb3c3460771a71f729c15bc6ced018916a432669fd239",
    urls = ["https://github.com/erlang/otp/archive/OTP-26.2.3.tar.gz"],
)
